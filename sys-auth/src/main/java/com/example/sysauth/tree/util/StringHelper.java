package com.example.sysauth.tree.util;
 ...
 * 开发人员: longtengbing longtengbing@hzregtech.com <br>
 * 开发时间: 15:31 <br>
 * 功能描述: 字符串工具类, 继承org.apache.commons.lang3.StringUtils类<br>
 */
public class StringHelper extends StringUtils {
  ...
  public static synchronized String getSerialNumber() {
    ...
    return DateHelper.getDate("yyyyMMddHHmmss") + String.format("%010d", hashCode);
  }
