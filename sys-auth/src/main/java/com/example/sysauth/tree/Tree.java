...
public class Tree extends AbstractTreeComponent implements ITree {
  ...
  public TreeComponent getRoot() {
    ...
    throw new RuntimeException("根节点不唯一");
  }
