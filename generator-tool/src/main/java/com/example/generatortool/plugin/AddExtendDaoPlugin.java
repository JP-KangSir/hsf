...
public class AddExtendDaoPlugin extends PluginAdapter {
    ...
    public boolean sqlMapGenerated(GeneratedXmlFile sqlMap, IntrospectedTable introspectedTable) {
        ...
        //mapperBaseName = introspectedTable.getFullyQualifiedTable().getDomainObjectName() + "Mapper";
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        daoBaseName = beanName+"Dao";
        mapperBaseName = beanName+"Mapper";
    ...
    public List<GeneratedXmlFile> contextGenerateAdditionalXmlFiles(IntrospectedTable introspectedTable) {
        String targetPackagePath = targetPackage.replaceAll("\\.", "/");
        StringBuilder filePath = getPath(targetPackagePath, ".xml");
        if (new File(filePath.toString()).exists()) {
            System.out.println(filePath + "文件存在，不生成");
            return null;
        }
        ...
        */
        ...
        GeneratedXmlFile gxf = new GeneratedXmlFile(document,
                mapperBaseName + ".xml", //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private CompilationUnit generateUnit(IntrospectedTable introspectedTable) {
        ...
        FullyQualifiedJavaType modelJavaType = new FullyQualifiedJavaType("com.baomidou.mybatisplus.mapper.BaseMapper");
    ...
    private StringBuilder getPath(String targetPackagePath, String type) {
        ...
        switch (type){
            case ".xml" :{
                filePath.append(mapperBaseName);
                break;
            }
            case ".java" :{
                filePath.append(daoBaseName);
                break;
            }
        }
